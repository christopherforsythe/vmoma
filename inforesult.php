...
$sqlread = "SELECT * FROM vmoma_artworks WHERE id = $artid";
...
<header>
  ...
  <?php
    ...
    $titleofwork = $result['title'];
    $bio = $result['artist_bio'];
    $date = $result['datecompleted'];
    $medium = $result['medium'];
    $dep = $result['department'];
    $img = $result['imgurlpath'];

    echo "   <div class='container' id='infobox' style='align-items: center;'>
              <div class='row'>
