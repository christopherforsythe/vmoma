...
<body>
    ...
    <div class="container-fluid backgroundimagewall">
        <!--form-->
      <div class="body3">
            <div class="container2" id="signinbox">
                ...
                <form class="form" id="form" action="validation.php" method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" placeholder="Username" id="username" name="username" class="signinformcontrol">                   
                        <div class="error-hint hidden"><small>Your name is required</small></div>
                    </div>
              
                    <div class="form-control">
                        <label>Password</label>
                        <input type="password" placeholder="Password" id="current-password" name="password" class="signinformcontrol">
                        <div class="error-hint hidden"><small>Your password is required</small></div>
                    </div>

                        <button type="submit" name="submit" class="bg-primary">Sign In</button>
                ...
                <?php
                    ...
                    if(isset($_GET["error"])){
                        ...
                        if($_GET["error"] == "emptyinput"){
                            ...
                            echo "<div class='form-control'style='text-align: center;'><p>Incorrect login details.</p></div>";
                        }
